...
#ifndef _DJM03AudioSTREAM_H
#define _DJM03AudioSTREAM_H
...
#define kSampleFractionAccumulatorRollover		65536 * 1000
...
class DJM03AudioStream : public IOAudioStream {
    friend class DJM03AudioDevice;
    friend class DJM03AudioEngine;

    OSDeclareDefaultStructors (DJM03AudioStream);

public:
    virtual bool initWithAudioEngine(DJM03AudioDevice * device, DJM03AudioEngine *engine, UInt16 interfaceNumber, IOAudioSampleRate sampleRate, const char *streamDescription = NULL, OSDictionary *properties = 0);
//    virtual bool initWithAudioEngine(DJM03AudioDevice * device, DJM03AudioEngine *engine, IOUSBInterface * streamInterface, IOAudioSampleRate sampleRate, const char *streamDescription = NULL, OSDictionary *properties = 0);
    virtual void free ();
//    virtual bool initHardware (IOService *provider);
	...
	static void	pluginLoaded (DJM03AudioStream * usbAudioStreamObject);
...
protected:
	...
	DJM03AudioEngine *				mUSBAudioEngine;
	...
	IOReturn	addAvailableFormats (DJM03ConfigurationDictionary * configDictionary);
	IOReturn	checkForFeedbackEndpoint (DJM03ConfigurationDictionary * configDictionary);
	...
	#endif
	virtual UInt64 generateTimeStamp (SInt32 usbFrameIndex, UInt32 preWrapBytes, UInt32 byteCount);
	virtual IOReturn copyAnchor (UInt64 anchorFrame, UInt64 * anchorTime, UInt64 * usbCycleTime); 	// <rdar://problem/7378275>
...
class DJM03AudioStreamNode : public IOService 					//<radr://6686515>
{
    OSDeclareDefaultStructors ( DJM03AudioStreamNode );
