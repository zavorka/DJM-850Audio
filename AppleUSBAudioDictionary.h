...
#ifndef __DJM03AudioDictionary__
#define __DJM03AudioDictionary__
...
class DJM03AudioDictionary : public OSDictionary 
{
	OSDeclareDefaultStructors (DJM03AudioDictionary);
...
class DJM03UnitDictionary : public DJM03AudioDictionary 
{
    OSDeclareDefaultStructors (DJM03UnitDictionary);
...
class AUAInputTerminalDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt16						terminalType;
...
class AUAOutputTerminalDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt16						terminalType;
//	UInt8						assocTerminal;
...
class AUAMixerUnitDictionary : public DJM03UnitDictionary 
{
//private:
...
class AUASelectorUnitDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt8 *						baSourceIDs;		// there are numInPins of these
//	UInt8						numInPins;
...
class AUAEffectUnitDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt8 *						bmaControls;
//	UInt8						controlSize;
...
class AUAProcessingUnitDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt8 *						bmControls;			// you don't know the size of this, calculate it using bLength and numInPins
//	UInt8 *						baSourceIDs;		// there are numInPins of these
...
class AUAExtensionUnitDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt8 *						bmControls;			// you don't know the size of this, calculate it using bLength and numInPins
//	UInt8 *						baSourceIDs;		// there are numInPins of these
...
class AUAFeatureUnitDictionary : public DJM03UnitDictionary 
{
//private:
//	UInt8 *						bmaControls;
//	UInt8						controlSize;
...
class AUAClockSourceDictionary : public DJM03UnitDictionary 
{
public:
...
class AUAClockSelectorDictionary : public DJM03UnitDictionary 
{
public:
	IOReturn					getNumInPins (UInt8 * numInPins) {return getDictionaryValue (kNumInPins, numInPins);}
...
class AUAClockMultiplierDictionary : public DJM03UnitDictionary 
{
public:
...
class DJM03EndpointDictionary;

class DJM03ControlDictionary : public DJM03AudioDictionary 
{
	friend class DJM03ConfigurationDictionary;

    OSDeclareDefaultStructors (DJM03ControlDictionary);
...
//    UInt8						numStreamInterfaces;	
	...
	DJM03UnitDictionary *					getUnitDictionary (UInt8 unitID);
...
public:
    static DJM03ControlDictionary *		create (void);
	...
	DJM03EndpointDictionary *		getIndexedEndpointDictionary (UInt8 index);
...
class DJM03EndpointDictionary : public DJM03AudioDictionary 
{
    OSDeclareDefaultStructors (DJM03EndpointDictionary);
...
public:
    static DJM03EndpointDictionary * 	create (void);
...
class AUAASEndpointDictionary : public DJM03EndpointDictionary 
{
//private:
...
class DJM03StreamDictionary : public DJM03AudioDictionary 
{
	friend class DJM03ConfigurationDictionary;

    OSDeclareDefaultStructors (DJM03StreamDictionary);
...
//  UInt8						terminalLink;
	...
	DJM03EndpointDictionary *			getEndpointByAddress (UInt8 address);
    DJM03EndpointDictionary *			getIndexedEndpointDictionary (UInt8 index);
    AUAASEndpointDictionary *		getIndexedASIsocEndpointDictionary (UInt8 index);
    DJM03EndpointDictionary *			getEndpointDictionaryByAddress (UInt8 address);
...
public:
    static DJM03StreamDictionary *		create (void);
...
class DJM03ConfigurationDictionary : public DJM03AudioDictionary 
{
    OSDeclareDefaultStructors (DJM03ConfigurationDictionary);
...
public:
    static DJM03ConfigurationDictionary *	create (const IOUSBConfigurationDescriptor * newConfigurationDescriptor, UInt8 controlInterfaceNum);
...
private:
	...
	DJM03ControlDictionary *			getControlDictionary (UInt8 interfaceNum, UInt8 altSettingID);
	OSArray *						getStreamDictionaries (void) {return getDictionaryArray (kStreamDictionaries);}
    DJM03StreamDictionary *			getStreamDictionary (UInt8 interfaceNum, UInt8 altSettingID);
