...
//--------------------------------------------------------------------------------
//
//	File:		DJM03AudioCommon.h
//
//	Contains:	Various debug switches for the DJM03Audio project
//
//	Technology:	OS X
//
//--------------------------------------------------------------------------------

#ifndef _DJM03AudioCOMMON_H
#define _DJM03AudioCOMMON_H
...
#define debugIOLog( m... )  IOLog(#m "\n", m)

// Following are a list of precompiler variables that affect the way that DJM03Audio executes, logs, and compiles.
...
// kMinimumSyncRefreshInterval is the smallest log base 2 amount of time in ms DJM03Audio will honor for a sync endppoint
...
//  Default length of DJM03AudioDevice timer interval in milliseconds
#define kRefreshInterval			128

// The following return codes are used by DJM03AudioDevice to detail the status of a format change.
enum 
{
