...
static void	ClipFloat32ToSInt16LE_4(const Float32* inInputBuffer, SInt16* outOutputBuffer, UInt32 inNumberSamples)
{
	...
	while(inNumberSamples > theLeftOvers)
	{
		...
		*(outOutputBuffer + 0) = (SInt16)(theFloat32Value1 * kFloat32ToSInt16);
		*(outOutputBuffer + 1) = (SInt16)(theFloat32Value2 * kFloat32ToSInt16);
		*(outOutputBuffer + 2) = (SInt16)(theFloat32Value3 * kFloat32ToSInt16);
		*(outOutputBuffer + 3) = (SInt16)(theFloat32Value4 * kFloat32ToSInt16);
...
IOReturn clipAudioToOutputStream(const void* mixBuf, void* sampleBuf, UInt32 firstSampleFrame, UInt32 numSampleFrames, const IOAudioStreamFormat *streamFormat)
{
    if(!streamFormat)
	{
...
IOReturn convertFromAudioInputStream_NoWrap (const void *sampleBuf,
												void *destBuf,
